...
export const ptbr: CompareContent = {
  ...
  description:
    "Compare o visualizador de MBOX online gratuito com o app de desktop Mbox Viewer para Mac — tamanho de arquivo, busca, privacidade e uso sem conexão.",
  intro:
  ...
  desktopLabel: "App de desktop (Mac)",
  rows: [
    { feature: "Preço", online: "Grátis", desktop: "Teste grátis · compra única" },
    { feature: "Instalação", online: "Nenhuma — funciona no navegador", desktop: "Mac App Store" },
    ...
    { feature: "Plataformas", online: "Qualquer navegador moderno", desktop: "macOS agora · Windows em breve" },
  ],
  closing:
