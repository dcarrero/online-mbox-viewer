...
export const es: CompareContent = {
  ...
  description:
    "Compara el visor de MBOX online gratuito con la app de escritorio Mbox Viewer para Mac — tamaño de fichero, búsqueda, privacidad y uso sin conexión.",
  intro:
  ...
  desktopLabel: "App de escritorio (Mac)",
  rows: [
    { feature: "Precio", online: "Gratis", desktop: "Prueba gratis · compra única" },
    { feature: "Instalación", online: "Ninguna — funciona en el navegador", desktop: "Mac App Store" },
    ...
    { feature: "Plataformas", online: "Cualquier navegador moderno", desktop: "macOS ahora · Windows muy pronto" },
  ],
  closing:
