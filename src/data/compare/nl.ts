...
export const nl: CompareContent = {
  ...
  description:
    "Vergelijk de gratis online MBOX-viewer met de Mbox Viewer desktop-app voor Mac en Windows — bestandsgrootte, zoeken, privacy en offline gebruik.",
  intro:
  ...
  desktopLabel: "Desktop-app (Mac en Windows)",
  rows: [
    { feature: "Prijs", online: "Gratis", desktop: "Gratis proefversie · eenmalige aankoop" },
    { feature: "Installatie", online: "Niets — draait in de browser", desktop: "Mac App Store · Microsoft Store" },
    ...
    { feature: "Platformen", online: "Elke moderne browser", desktop: "macOS · Windows" },
  ],
  closing:
