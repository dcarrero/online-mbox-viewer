...
export const it: CompareContent = {
  ...
  description:
    "Confronta il visualizzatore MBOX online gratuito con l'app desktop Mbox Viewer per Mac — dimensione dei file, ricerca, privacy e uso offline.",
  intro:
  ...
  desktopLabel: "App desktop (Mac)",
  rows: [
    { feature: "Prezzo", online: "Gratuito", desktop: "Prova gratuita · acquisto una tantum" },
    { feature: "Installazione", online: "Nessuna — funziona nel browser", desktop: "Mac App Store" },
    ...
    { feature: "Piattaforme", online: "Qualsiasi browser moderno", desktop: "macOS ora · Windows in arrivo" },
  ],
  closing:
