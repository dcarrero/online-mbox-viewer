...
export const de: CompareContent = {
  ...
  description:
    "Vergleichen Sie den kostenlosen Online-MBOX-Viewer mit der Desktop-App Mbox Viewer für Mac — Dateigröße, Suche, Datenschutz und Offline-Nutzung.",
  intro:
  ...
  rows: [
    ...
    { feature: "Installation", online: "Keine — läuft im Browser", desktop: "Mac App Store" },
    ...
    { feature: "Plattformen", online: "Jeder moderne Browser", desktop: "macOS jetzt · Windows demnächst" },
  ],
  closing:
