...
export const fr: CompareContent = {
  ...
  description:
    "Comparez le visualiseur MBOX en ligne gratuit avec l'application de bureau Mbox Viewer pour Mac et Windows — taille de fichier, recherche, confidentialité et utilisation hors ligne.",
  intro:
