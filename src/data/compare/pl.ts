...
export const pl: CompareContent = {
  ...
  description:
    "Porównaj darmową przeglądarkę plików MBOX online z aplikacją desktopową Mbox Viewer for Mac — rozmiar plików, wyszukiwanie, prywatność i praca offline.",
  intro:
  ...
  desktopLabel: "Aplikacja desktopowa (Mac)",
  rows: [
    { feature: "Cena", online: "Darmowa", desktop: "Darmowy okres próbny · jednorazowy zakup" },
    { feature: "Instalacja", online: "Brak — działa w przeglądarce", desktop: "Mac App Store" },
    ...
    { feature: "Platformy", online: "Dowolna nowoczesna przeglądarka", desktop: "macOS już teraz · Windows wkrótce" },
  ],
  closing:
