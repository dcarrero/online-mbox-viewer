...
export const en: CompareContent = {
  ...
  description:
    "Compare the free online MBOX viewer with the Mbox Viewer desktop app for Mac and Windows — file size, search, privacy and offline use.",
  intro:
  ...
  rows: [
    ...
    { feature: "Install", online: "Nothing — runs in the browser", desktop: "Mac App Store · Microsoft Store" },
    ...
    { feature: "Platforms", online: "Any modern browser", desktop: "macOS · Windows" },
  ],
  closing:
