...
export const ko: CompareContent = {
  ...
  description:
    "무료 온라인 MBOX 뷰어와 Mac·Windows용 Mbox Viewer 데스크톱 앱을 비교해 보세요 — 파일 크기, 검색, 개인정보 보호 및 오프라인 사용.",
  intro:
    "둘 다 여러분의 이메일을 로컬에서 비공개로 읽습니다. 브라우저 뷰어는 작은 아카이브를 살펴보는 가장 빠른 방법이며, 데스크톱 앱은 큰 아카이브와 고급 기능을 위해 만들어졌습니다.",
  onlineLabel: "온라인 뷰어",
  desktopLabel: "데스크톱 앱 (Mac·Windows)",
  rows: [
    { feature: "가격", online: "무료", desktop: "무료 체험 · 1회 구매" },
    { feature: "설치", online: "필요 없음 — 브라우저에서 실행", desktop: "Mac App Store · Microsoft Store" },
    ...
    { feature: "플랫폼", online: "모든 최신 브라우저", desktop: "macOS · Windows" },
  ],
  closing:
