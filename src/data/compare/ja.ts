...
export const ja: CompareContent = {
  ...
  description:
    "無料のオンライン MBOX ビューアと Mac・Windows 向けの Mbox Viewer デスクトップアプリを比較します。ファイルサイズ、検索、プライバシー、オフライン利用について。",
  intro:
  ...
  desktopLabel: "デスクトップアプリ（Mac・Windows）",
  rows: [
    { feature: "価格", online: "無料", desktop: "無料体験版 · 買い切り" },
    { feature: "インストール", online: "不要 — ブラウザで動作", desktop: "Mac App Store · Microsoft Store" },
    ...
    { feature: "対応プラットフォーム", online: "あらゆる最新ブラウザ", desktop: "macOS · Windows" },
  ],
  closing:
