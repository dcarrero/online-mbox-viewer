...
function build(max: number): Record<string, ViewerCopy> {
  return {
    en: {
      ...
      multiple: "Only the first file was opened: {name}.",
    ...
    es: {
      ...
      multiple: "Solo se abrió el primer fichero: {name}.",
    ...
    de: {
      ...
      multiple: "Es wurde nur die erste Datei geöffnet: {name}.",
    ...
    fr: {
      ...
      multiple: "Seul le premier fichier a été ouvert : {name}.",
    ...
    "pt-br": {
      ...
      reading: "Lendo {name}…",
      multiple: "Apenas o primeiro arquivo foi aberto: {name}.",
    ...
    it: {
      ...
      multiple: "È stato aperto solo il primo file: {name}.",
    ...
    nl: {
      ...
      multiple: "Alleen het eerste bestand is geopend: {name}.",
    ...
    pl: {
      ...
      multiple: "Otwarto tylko pierwszy plik: {name}.",
